...
* Fixed error reporting when Sentinel Hub API returns an HTTP error status between 400 and 429. 
  Now a `SentinelHubError` is raised with complete error information.
